source "qemu" "rockylinux-8" {
  iso_checksum      = "file:https://download.rockylinux.org/pub/rocky/8/isos/x86_64/Rocky-8-latest-x86_64-boot.iso.CHECKSUM"
  iso_url           = "https://download.rockylinux.org/pub/rocky/8/isos/x86_64/Rocky-8-latest-x86_64-boot.iso"

  output_directory  = "outputs/rockylinux-8"
  accelerator       = "kvm"
  ...
  http_directory    = "http/rockylinux"
  ssh_port          = 22
  ssh_timeout       = "30m"
  ssh_username      = "root"
